...
const Cart = () => {
  ...
  return (
    <Modal
      onClose={handleClose}
      classes="float-right h-screen fixed right-0 top-0 z-[10000] duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-2"
    >
